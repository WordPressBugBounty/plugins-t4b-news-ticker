    ...
    class T4BNT_WeDevs_Settings_API {
        ...
        function callback_text( $args ) {
            ...
            $html = sprintf(
                ...
                $type, $size, esc_attr( $args['section'] ), esc_attr( $args['id'] ), $value, $placeholder
            );
        ...
        function callback_checkbox( $args ) {
            ...
            $html .= sprintf(
                ...
                esc_attr( $args['section'] ), esc_attr( $args['id'] ), checked( $value, 'on', false )
            );
        ...
        function callback_multicheck( $args ) {
            ...
            foreach ( $args['options'] as $key => $label ) {
                ...
                $html .= sprintf(
                    ...
                    esc_attr( $args['section'] ), esc_attr( $args['id'] ), esc_attr( $key ), checked( $checked_value, $key, false )
                );
