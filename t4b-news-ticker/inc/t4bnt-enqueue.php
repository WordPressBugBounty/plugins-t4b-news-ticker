        ...
        public function t4bnt_enqueue_script() {
            ...
            if ( $t4bnt_enable == 'on' ) {
                if ( $ticker_effect == 'scroll' ) {
                    wp_enqueue_script( 't4bnt-script', T4BNT_PLUGIN_URL . 'assets/js/t4bnt.liscroll.js', array('jquery'), '1.4.5', ['in_footer' => true] );
                } else {
                    wp_enqueue_script( 't4bnt-script', T4BNT_PLUGIN_URL . 'assets/js/t4bnt.atickers.js', array('jquery'), '1.4.5', ['in_footer' => true] );
                }
                if ( $ticker_effect == 'scroll' ) {
                    wp_enqueue_style( 't4bnt-style', T4BNT_PLUGIN_URL . 'assets/css/t4bnt-styles.css', [], '1.4.5' );
                } else {
                    wp_enqueue_style( 't4bnt-style', T4BNT_PLUGIN_URL . 'assets/css/t4bnt-scroll.css', [], '1.4.5' );
                }
            }
        }
    }
