        ...
        **/
        public function t4bnt_display_admin_notice() {
            ...
            if ( is_admin() && $pagenow === 'admin.php' && isset( $_GET['page'] ) && sanitize_text_field( wp_unslash( $_GET['page'] ) ) === 't4bnt-settings' ) {
                ...
                printf(
                    '<div id="t4bnt-review" class="t4bnt-notice t4bnt-notice-success t4bnt-is-dismissible">
                        <span class="t4bnt-close-icon">&times;</span>
                        <p>%1$s</p>
                        <p>%2$s</p>
                    ...
                    esc_html__( 'Your feedback is important to us and can help us improve. If you find our ', 't4b-news-ticker' ) . '<b>' . esc_html( $plugin_name ) . '</b>' . esc_html__( ' plugin valuable, could you please take a moment to share your thoughts by leaving a quick review?', 't4b-news-ticker' ),
                    esc_url( $review_url ),
